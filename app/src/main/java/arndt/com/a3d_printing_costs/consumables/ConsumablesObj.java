...
public class ConsumablesObj implements DataModel {
    @NonNull
    @PrimaryKey
    public String uuid;
    @ColumnInfo
    public StringBuilder key = new StringBuilder(), value = new StringBuilder(), unit = new StringBuilder("$");
    ...
    @Ignore
    public ConsumablesObj() {
        this.uuid = UUID.randomUUID().toString();
        setUpBindings();
    }

    public ConsumablesObj(String key, String value, String unit) {
        this.uuid = UUID.randomUUID().toString();
    ...
    public ConsumablesObj(@NonNull String uuid, StringBuilder key, StringBuilder unit, StringBuilder value) {
        this.uuid = uuid;
        this.key = key;
        this.unit = unit;
        this.value = value;
