...
@Entity(tableName = "postprocessings")
public class PostProcessingsObj implements DataModel {
    @NonNull
    @PrimaryKey
    public String uuid;
    @ColumnInfo
    ...
    @Ignore
    public PostProcessingsObj() {
        this.uuid = UUID.randomUUID().toString();
        setUpBindings();
    }

    public PostProcessingsObj(String key, String value, String unit) {
        this.uuid = UUID.randomUUID().toString();
    ...
    public PostProcessingsObj(@NonNull String uuid, StringBuilder key, StringBuilder unit, StringBuilder value) {
        this.uuid = uuid;
        this.key = key;
        this.unit = unit;
        this.value = value;
